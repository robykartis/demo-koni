...
class CakunControler extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if ($g == null) {
            ...
            return redirect()->route('cakun.index')->with('message', 'Data Berhasil Disimpan');
        } else {
            $validator = Validator::make(
                $request->all(),
                [
    ...
    public function changePasswordPost(Request $request)
    {
        if (!(Hash::check($request->get('current-password'), Auth::user()->password))) {
            ...
            return redirect()->back()->with("error", "ERRORR !! Password Baru tidak cocok dengan Password lama.");
        }
