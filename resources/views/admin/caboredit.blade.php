    ...
    <div class="page-content">
        ...
        <div class="mx-auto">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <h5 class="pe-6">Edit Data Cabang Olahraga</h5>
        ...
        <div class="mx-auto">
            <div class="main-body">
                <form action="{{ url('admin/updatecabor') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <select class="form-select mb-3" name="id_induk" required aria-label="Default select example">
                                                <option selected value="{{ $data->idkat }}">{{ $data->indukp }} - ({{ $data->indukpendek }})</option>
                                                @foreach ($kat as $p)
                                                <option value="{{$p->id}}">
