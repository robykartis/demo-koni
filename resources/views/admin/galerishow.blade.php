    ...
    <div class="page-content">
        ...
        <div class="mx-auto">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <h5 class="pe-6">Detail Data Galeri Foto</h5>

                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="{{ route('galerifoto.index') }}" type="button" class="btn btn-secondary">Back</a>
                ...
                <form action="{{ route('galerifoto.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="text-primary">1. Konten Galeri</h6>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-3 text-secondary">
                                            <input type="date" name="tgl" value="{{ $data->tgl }}" readonly required class="form-control" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <h6 class="text-primary">2. Foto Galeri</h6>
                                    <hr>
                                    <div class="row">
                                        @foreach($allfoto as $p)
                                        <div class="col-md-6">
                                            <div class="card">
                                                <img src="{{ asset('berkas/galerifoto/thumbnail/'.$p->foto) }}">
                                            </div>
