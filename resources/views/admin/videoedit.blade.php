                ...
                <form action="{{ url('admin/updatevideo') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="text-primary">1. Konten Galeri Video</h6>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-3 text-secondary">
                                            <input type="date" value="{{ $data->tgl }}" name="tgl" required class="form-control" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <h6 class="text-primary">2. Video Galeri</h6>

                                    <hr>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Link Youtube Video </h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="video" value="{{ $data->video }}" placeholder="contoh: https://youtube.com/xdcfYs" required class="form-control" />
                                        </div>
                                    </div>
