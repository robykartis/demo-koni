    ...
    <div class="page-content">
        ...
        <div class="mx-auto">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <h5 class="pe-6">Detail Data Agenda Kegiatan</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="judul" readonly value="{{ $data->namakat }}" required class="form-control" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-3 text-secondary">
                                            <input type="text" name="tgl" value="{{ $data->waktu }}" readonly required class="form-control" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <h6 class="text-primary">2. Foto Dokumentasi Agenda Kegiatan</h6>
                                    <hr>
                                    <div class="row">
                                        @foreach($allfoto as $p)
                                        <div class="col-md-6">
                                            <div class="card">
                                                <img src="{{ asset('berkas/agenda/thumbnail/'.$p->foto) }}">
                                            </div>
