            ...
            <div class="card">
                <div class="row g-0">
                    <div class="col-md-4 border-end">
                        <img src="{{ asset('berkas/atlet/thumbnail/'.$data->foto) }}" height="100%" width="100%" alt="">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-9">: {{ $data->jk }}</dd>

                                <dt class="col-sm-3">Agama</dt>
                                <dd class="col-sm-9">: {{ $data->agama }}</dd>


                                <dt class="col-sm-3">No Handphone</dt>
                                <dd class="col-sm-9">: {{ $data->nohp }}</dd>
                                <dt class="col-sm-3">Alamat Lengkap</dt>
                                <dd class="col-sm-9">: {{ $data->alamat }}, Kelurahan {{ $data->lurah }}, Kecamatan {{ $data->camat }} </dd>
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-9">: {{ $data->ayah }}</dd>

                                <dt class="col-sm-3">Nama Ibu</dt>
                                <dd class="col-sm-9">: {{ $data->ibu }}</dd>
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-9">: {{ $data->cabor }}</dd>

                                <dt class="col-sm-3">Club / Binaan</dt>
                                <dd class="col-sm-9">: {{ $data->club }}</dd>
