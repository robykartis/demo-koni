    ...
    <div class="page-content">
        ...
        <div class="mx-auto">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <h5 class="pe-6">Edit Data Club/Binaan</h5>
        ...
        <div class="mx-auto">
            <div class="main-body">
                <form action="{{ url('admin/updateclub') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <select class="form-select mb-3" name="id_cabor" required aria-label="Default select example">
                                                <option selected value="{{ $data->idkat }}">{{ $data->namacabor }}</option>
                                                @foreach ($kat as $p)
                                                <option value="{{$p->id}}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="club" value="{{ $data->club }}" required class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <label class="card-title cursor-pointer">
                                                ...
                                                <img id="blah" src="{{ asset('berkas/club/thumbnail/'.$data->logo) }}" class="card-img-top" />
                                            </label>
                                        </div>
                                    </div>
                                    <hr>
