...
<div class="main-content">
    ...
    <section class="other-hero bg-img" data-src="{{ asset('front/contoh/bgbaner.jpg') }}">
        <div class="container other-hero-text">
            <h1>Detail Data Club</h1>
            <ul class="breadcrumb">
                <li><a href="{{ url('/') }}">Home</a></li>
                <li>Detail Data Club</li>
            </ul>
        </div>
    </section>
    <!-- End Hero Section -->
    ...
    <section class="contact section" id="contact">
        <div class="container">
            <div class="section-header type1">
                <h4>{{ $detail->club }}</h4>
                <img src="{{ asset('berkas/club/thumbnail/'.$detail->logo) }}" style="width:10%" alt="">
            ...
            <div class="row flex">
                ...
                <div class="col-xl-12 mt-3">
                    <div class="card">
                        <div class="card-header text-center">Map Club</div>
                        <div id="mapc"></div>
                    </div>
                </div><!-- .col -->
...
<script>
    ...
    var iconMap = L.icon({
        ...
        iconUrl: '../../../public/berkas/club/thumbnail/' + lo + ''
    });
    var marker = L.marker([lati, long], {

        }).addTo(map)
        .bindPopup('<div><img height="80px" width="90px" src="../../../public/berkas/club/thumbnail/' + lo + '"> </div> <hr><a href="https://maps.google.com/?q= ' + lati + ', ' + long + '" target="_blank" class="text-info">klik rute lokasi</a>').openPopup();
