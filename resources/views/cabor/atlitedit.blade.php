...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="mx-auto">
            <div class="main-body">
                <form action="{{ url('cabor/updatecatlit') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="nia" class="form-control" value="{{ $data->nia }}" required id="inputFirstName">
                                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-responsive" id="dynamicTable">
                                ...
                                <form action="{{ url('cabor/ubahprestasi') }}" method="POST">
                                    @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('cabor/preshapus',$pr->id) }}" type="submit" class="btn btn-danger btn-sm"><i class='bx bx-trash me-0'></i></a>
...
<div class="modal fade " id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog lg">
        <form action="{{ url('cabor/simpanpres') }}" method="POST" enctype="multipart/form-data">
            @csrf
...
<script>
    $(document).ready(function() {
        $('#country-dd').on('change', function() {
            ...
            $("#state-dd").html('');
            $.ajax({
                url: "{{url('cabor/api/fetch-cities')}}",
                type: "POST",
                data: {
                    kec_id: idCountry,
                    _token: '{{csrf_token()}}'
