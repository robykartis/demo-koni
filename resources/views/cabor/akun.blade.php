...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="mx-auto">
            <div class="main-body">
                <form action="{{ route('cakun.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="panel-body">
                            ...
                            <form autocomplete=’off’ class="form-horizontal" method="POST" action="{{ url('cabor/akun/changePassword') }}">
                                {{ csrf_field() }}
