    ...
    <div class="page-content">
        ...
        <div class="mx-auto">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <h5 class="pe-6">Tambah Data Wasit/Juri</h5>
        ...
        <div class="mx-auto">
            <div class="main-body">
                <form action="{{ route('cwasit.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="tgl_terbit" class="form-control" id="inputFirstName">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label for="inputFirstName" class="form-label">Level Wasit/Juri</label>
