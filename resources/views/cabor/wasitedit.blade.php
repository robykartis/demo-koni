    ...
    <div class="page-content">
        ...
        <div class="mx-auto">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <h5 class="pe-6">Edit Data Wasit/Juri</h5>

                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="{{ route('cwasit.index') }}" type="button" class="btn btn-secondary">Back</a>
        ...
        <div class="mx-auto">
            <div class="main-body">
                <form action="{{ url('cabor/updatecwasit') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Foto Wasit</h6><br>
                                        ...
                                        <div class="col-sm-3 text-secondary">
                                            <label class="card-title cursor-pointer">
                                                ...
                                                <img id="blah" src="{{ asset('berkas/wasit/thumbnail/'.$data->foto) }}" class="card-img-top" />
                                            </label>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-6">
                                            <label for="inputFirstName" class="form-label">Nomor Sertifikat Wasit</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="tgl_terbit" value="{{ $data->tgl_terbit }}" class="form-control" id="inputFirstName">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label for="inputFirstName" class="form-label">Level Wasit</label>
