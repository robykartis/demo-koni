                        ...
                        <header class="entry-header">
                            ...
                            <div class="post-thumbnail">
                                ...
                                <div class="row mx-auto">
                                    ...
                                    <iframe width="100%" height="400" src="https://youtube.com/embed/{{ substr($detail->video, -11) }}?rel=0&modestbranding=1&autohide=1&showinfo=0&controls=0" allowfullscreen></iframe>
                            ...
                            <div class="post-details-wrap">
                                ...
                                <div class="byline">
                                    ...
                                    <span class="posted-on"><a href="#"><i class="fa fa-calendar"></i>{{$detail->tgl_video_formatsatu()}}</a></span>
